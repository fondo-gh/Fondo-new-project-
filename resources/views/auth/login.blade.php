...
<head>
    ...
    <title>Fondo App | Entrepreneur Login</title>
...
<!-- END: Head-->
<body
    class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu 1-column   blank-page blank-page"
                    ...
                    <form class="login-form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <p class="ml-4">Login in now as an Entrepreneur!</p>
                            </div>
                        </div>
                        ...
                        <div class="row margin">
                            <div class="input-field col s12">
                                ...
                                @error('email')
                                <span class="red-text"
                                      style="text-align: center;"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        </div>
                        <div class="row margin">
