<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
    <div class="brand-sidebar">
        <h1 class="logo-wrapper">
            <a class="brand-logo darken-1" href="#"><img src="{{ asset('app-assets/images/logo/materialize-logo-color.png') }}" alt="materialize logo"/><span class="logo-text hide-on-med-and-down">Fondo</span></a>
        </h1>
    </div>
    <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        ...
        <li class="bold {{ Route::is('startup') ? 'active' : '' }}"><a class="waves-effect waves-cyan {{ Route::is('startup') ? 'active' : '' }}" href="{{ route('startup') }}"><i class="material-icons">widgets</i><span class="menu-title" data-i18n="">Startup Page</span></a>
        </li>
