<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
    <div class="brand-sidebar">
        <h1 class="logo-wrapper">
            <a class="brand-logo darken-1" href="{{ asset('app-assets/images/logo/materialize-logo-color.png') }}"><img src="{{ asset('app-assets/images/logo/materialize-logo-color.png') }}" alt="materialize logo"/><span class="logo-text hide-on-med-and-down">Fondo Investor</span></a>
        </h1>
    </div>
...
{{--        </li>--}}
        <li class="bold {{ Route::is('dashboard') ? 'active' : '' }}"><a class="waves-effect waves-cyan {{ Route::is('dashboard') ? 'active' : '' }}" href="{{ route('dashboard') }}"><i class="material-icons">widgets</i><span class="menu-title" data-i18n="">Startups Dashboard</span></a>
        </li>
