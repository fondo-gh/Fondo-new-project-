...
{{--        </li>--}}
        <li class="bold {{ Route::is('admin.dashboard') ? 'active' : '' }}"><a class="waves-effect waves-cyan active gradient-shadow gradient-45deg-grey {{ Route::is('admin.dashboard') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}"><i class="material-icons">widgets</i><span class="menu-title" data-i18n="">Dashboard</span></a>
        </li>
